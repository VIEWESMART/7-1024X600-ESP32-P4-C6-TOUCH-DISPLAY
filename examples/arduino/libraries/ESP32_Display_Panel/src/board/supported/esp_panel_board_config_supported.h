 ...
 */
    ...
    // Check if multiple boards are enabled
        ...
        + defined(BOARD_VIEWE_UEED32480035E_WB_A) \
        ...
        + defined(BOARD_VIEWE_ESP32_P4_PI_7INCH_DSI) \
        + defined(BOARD_VIEWE_UEP4S070H1024V600C_WBA) \
        > 1
    ...
    #elif defined(BOARD_VIEWE_UEED32480035E_WB_A)
        #include "viewe/BOARD_VIEWE_UEED32480035E_WB_A.h"
    ...
    #elif defined(BOARD_VIEWE_ESP32_P4_PI)
        #include "viewe/BOARD_VIEWE_ESP32_P4_PI.h"
    #elif defined(BOARD_VIEWE_UEP4S070H1024V600C_WBA)
        #include "viewe/BOARD_VIEWE_UEP4S070H1024V600C_WBA.h"
    #else
