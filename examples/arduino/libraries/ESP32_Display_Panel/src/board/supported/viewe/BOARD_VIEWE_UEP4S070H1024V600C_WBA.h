 ...
 */
/**
 * @file   BOARD_VIEWE_UEP4S070H1024V600C_WBA.h
 * @brief  Configuration file for VIEWE UEP4S070H1024V600C-WBA board
 * @author VIEWE@Ayang
 * @link   https://github.com/VIEWESMART/7-1024X600-ESP32-P4-C6-TOUCH-DISPLAY
 */
 ...
 * @brief Board name
 */
#define ESP_PANEL_BOARD_NAME                "VIEWE:UEP4S070H1024V600C-WBA"
 ...
 */
    ...
    #define ESP_PANEL_BOARD_LCD_MIPI_DSI_LANE_RATE_MBPS     (600)  // Single lane bit rate, should check the LCD drive IC
    ...
    #define ESP_PANEL_BOARD_LCD_MIPI_DPI_CLK_MHZ            (50)
 ...
 */
#define ESP_PANEL_BOARD_LCD_RST_IO              (22)    // Reset pin, -1 if not used
 ...
 */
 ...
 {  \
     constexpr gpio_num_t PWR_1_8V_EN = static_cast<gpio_num_t>(4); \
     constexpr gpio_num_t PWR_3_3V_EN = static_cast<gpio_num_t>(5); \
     gpio_set_direction(PWR_1_8V_EN, GPIO_MODE_OUTPUT); \
     gpio_set_direction(PWR_3_3V_EN, GPIO_MODE_OUTPUT); \
     gpio_set_level(PWR_1_8V_EN, 1); \
     vTaskDelay(pdMS_TO_TICKS(30)); \
     gpio_set_level(PWR_3_3V_EN, 1); \
     ESP_UTILS_LOGI("ESP_PANEL_BOARD_PRE_BEGIN_FUNCTION");\
     return true;    \
 }
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////// File Version ///////////////////////////////////////////////////////////
